		...
		<div class="">
			...
			<div class="col-lg-3 col-xs-3">
				<div class="row">
				  ...
				  <img src="{{ asset('assets/images/404-logo.jpg') }}" alt="" class="img-responsive" style="display: initial !important; text-align: center" />
				</section>
				</div>
			</div>

			{{-- <div class="col-lg-3 col-xs-12 text-center" style="padding:5% 0; background: white; height: 100vh;">
				<div class="logo" style="padding: 30% 0; text-align: center;"></div>
			</div> --}}
