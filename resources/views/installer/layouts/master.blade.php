...
<html>
    ...
    <div id="loading" style="display: none">
        <div><img src="{{ asset('assets/cal-Loading.gif') }}" alt=""></div>
        ...
        <div class="master">
            <div class="box" id="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item @if(Request::get('step') == 'finish') active @endif">
                        <i class="step__icon fa fa-flag-checkered" aria-hidden="true"></i>
                    </li>
                    
                    <li class="step__divider"></li>
                    <li class="step__item @if(Request::get('step') == 4 || Request::get('step') == 5 || Request::get('step') == 6) active @endif">
                        <i class="step__icon fa fa-cogs" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    
                    <li class="step__item @if(Request::get('step') == 3) active @endif">
                        @if(Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ url('install?step=3') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item @if(Request::get('step') == 2) active @endif">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item @if(Request::get('step') == 1) active @endif">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item @if(Request::get('step') == 0) active @endif">
                        @if(Request::get('step') == 0)
                            <a href="{{ url('install?step=0') }}">
