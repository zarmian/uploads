    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-3 col-md-1 col-sm-1 col-xs-12 plus-margin">
          <a class="plus" href="{{ url('/loan-request/create') }}">+</a>
        </div>
  ...
  <div class="row">
    <div class="container">
      ...
      <div id="products" class="row ">
            ...
            <div class="row">
                ...
                <ul class="list-detail">
                  <li>
                    <div class="caption">
                      <ul>
                        <li class="name">{{ $loan->title }} </li>
                        <li class="timing"><b>@lang('admin/leaves.date_text')</b> {{ $loan->datetime }}</li>
                ...
                <ul class="inner-btn clearfix">
                  <li><a href="{{ url('/loan-request/edit', $loan->id) }}" data-toggle="tooltip" title="@lang('employees/common.edit_tooltip')"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></li>
                  @if($loan->status <> 1)
                    <li><a href="{{ url('/loan-request/remove', $loan->id) }}" data-toggle="tooltip" title="@lang('employees/common.delete_tooltip')" class="is_delete"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
                  @endif
                  <li><a href="javascript:void(0)" data-toggle="modal" data-target="#loanModal" data-id="{{ $loan->id }}" rel="tooltip" title="@lang('employees/common.view_detail_txt')"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span></a></li>
                </ul>
        ...
        @endforeach
          <div class="col-xs-12">{{ $loans->appends(\Input::except('page'))->render() }}</div>
        @else
